...
6.  We’ve been spending a lot of time on this plot. This is because I
    ...
    improved in this figure, \* The axis titles are not meaningful. \*
    There is a strange gap between the left hand edge of the plot and
    the start of the bars. \* I would also prefer if the bars were
    exactly touching one another, without the small vertical gap. \* The
    scientific notation for population size is unnecessarily
    technical. \* The color scheme is a bit boring^\[.
